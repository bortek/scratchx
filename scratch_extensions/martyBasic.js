...
var ext = {};
loadScript("https://bortek.github.io/scratchx/scratch_extensions/martyScratch.js?v=20180924", registerExtension);
//loadScript("/scratch_extensions/martyScratch.js?v=20180910", registerExtension);
...
function registerExtension(){
    ...
    var descriptor = {
        blocks: [
            ...
            ['w', 'Sidestep %m.leg for %n step(s)', 'sidestep_basic', 'left', 1],
